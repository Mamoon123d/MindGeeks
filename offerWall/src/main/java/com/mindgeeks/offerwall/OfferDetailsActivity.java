...
public class OfferDetailsActivity extends AppCompatActivity {
    ...
    //text view
    private TextView title_tv, des_tv, rewards_tv, task_tv, rec_reward_tv,instructions_tv,step1_tv,step2_tv,uptoAmount_tv;
            ...
            detailDataCall.enqueue(new Callback<OfferDetailData>() {
                ...
                public void onResponse(@NotNull Call<OfferDetailData> call, @NotNull Response<OfferDetailData> response) {
                   ...
                   // SharedPreferences sharedPreferences = getSharedPreferences(MainActivity.UserPreferences, Context.MODE_PRIVATE);
                    ...
                    List<OfferDetailData.Instruction> list=new ArrayList<>();
                    ...
                    uptoAmount_tv.setText("Upto "+getString(R.string.rupees)+" "+data.getOfferDetails().getOfferAmount());
    ...
    private void init() {
        ...
        uptoAmount_tv=findViewById(R.id.offer_upto_amount_tv);
